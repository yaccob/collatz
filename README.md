...
**[Read the manuscript (PDF)](manuscripts/obstruction_residues/obstruction_residues.pdf)**
...
a primitive substitution shift). See the
[LaTeX source](manuscripts/obstruction_residues/obstruction_residues.tex) and its
[`code/README.md`](manuscripts/obstruction_residues/code/README.md) for the
script-to-result mapping.

### obstruction_residues_family

**[Read the manuscript (PDF)](manuscripts/obstruction_residues_family/obstruction_residues_family.pdf)**
...
manuscript. See the
[LaTeX source](manuscripts/obstruction_residues_family/obstruction_residues_family.tex) and its
[`code/README.md`](manuscripts/obstruction_residues_family/code/README.md) for the
script-to-result mapping.

### negative_mersenne

**[Read the manuscript (PDF)](manuscripts/negative_mersenne/negative_mersenne.pdf)**
...
bound. See the
[LaTeX source](manuscripts/negative_mersenne/negative_mersenne.tex) and its
[`code/README.md`](manuscripts/negative_mersenne/code/README.md) for the
script-to-result mapping.
