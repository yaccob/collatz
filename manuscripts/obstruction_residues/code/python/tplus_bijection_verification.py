"""Empirical verification of Residue involution / bijection (`lem:involution-step` / `thm:tplus-bijection`).
...
def main():
    ...
    print(f"Residue involution / bijection (`lem:involution-step` / `thm:tplus-bijection`) verification at L = {L}\n")
