...
\subjclass[2020]{11B83, 37P05, 37B10, 37B40, 37A99, 68R15, 11A07}
...
Berth\'e--Rigo~\cite{BertheRigo2010} for a modern collected reference on
...
at the base levels gives $\Atom_5 = \{27\}$ and $\Atom_6 = \{19\}$,
both with shift $a = 1$, so
...
% \sloppypar restores tolerant line breaking; this paragraph overflows
% the column by ~4.5pt without it due to long compound terms.
\begin{sloppypar}
...
% \sloppypar restores tolerant line breaking; this paragraph overflows
% the column by ~1.8pt without it (long hyphenated terms and author names).
\begin{sloppypar}
